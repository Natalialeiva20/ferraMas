...
SECRET_KEY = 'django-insecure-!0nyz(sf2v^d93hkton_dij49li-v=5$7je&a+9ylg@kvg9a0_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['pro.uri1000.win',
                'localhost',
                '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Cambiado para evitar conflicto con plantillas globales
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
